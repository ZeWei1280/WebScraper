...
func ParseFlags() (string, string, int) {
	...
	flag.IntVar(&concurrency, "c", 1, "number of goroutines to process files concurrently (>0)")
	flag.IntVar(&concurrency, "concurrency", 1, "number of goroutines to process files concurrently (>0)")
